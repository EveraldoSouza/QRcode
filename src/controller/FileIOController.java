...
public final class FileIOController{
    ...
    public boolean carregarConfiguracoes(QRCodeConfigModel QRConfig){
        try {
            ...
            try{
                ...
                QRConfig.setCheckBoxSalvarDB(Boolean.valueOf(fileConfig.get(7)));
            }catch(Exception ex){ // Evitar que o arquivo possua menos campos e de exception 
                escreverConfiguracoes(QRConfig);
            }
    ...
    public boolean escreverConfiguracoes(QRCodeConfigModel QRConfig){
            ...
            fileConfig.add(String.valueOf(QRConfig.isCheckBoxSalvarDB())); // Salvar estado da checkbox
